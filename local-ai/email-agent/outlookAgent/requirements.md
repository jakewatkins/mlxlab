...
This tool will download all email from my outlook account and store the emails in a json file called outlook-email.json.
...
- The Service property will be hardcoded to "Outlook"
