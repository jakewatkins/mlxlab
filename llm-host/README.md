...
- 💬 **Streaming responses** - Typewriter-style token streaming for real-time feedback
- 🔄 **Multi-turn tool execution** - Automatic tool calling with unlimited iterations
- ⏱️ **Tool monitoring** - Detailed logging of tool calls with timing and results
- 🎨 **Rich console output** - Colored, formatted output for better readability
...
│   ├── cli.py            # Command-line interface and main loop
